...
INSERT INTO customer(username, email, firstname, lastname, phone, `password`, postcode, country, city, number_house,
                     street, authorities, `account_non_expired`, `account_non_locked`, `credentials_non_expired`,
                     `enabled`)
VALUES ("admin", "email@email.com", "admin", "adminLastname", "2222",
        "$2a$10$qECA6EH5ND2xA.PJ5qeMnOUo.g55rBIIWQagvlHxXv4hNbBoDjTiG", 6700, "Belgique", "Arlon", 10, "rue d''arlon",
        "ROLE_ADMIN", 1, 1, 1, 1);

INSERT INTO customer(username, email, firstname, lastname, phone, `password`, postcode, country, city, number_house,
                     street, authorities, `account_non_expired`, `account_non_locked`, `credentials_non_expired`,
                     `enabled`)
VALUES ("customer", "customer@email.com", "customer", "customerLastname", "5555",
        "$2a$10$qECA6EH5ND2xA.PJ5qeMnOUo.g55rBIIWQagvlHxXv4hNbBoDjTiG", 6700, "Belgique", "Arlon", 10, "rue d''arlon",
        "ROLE_USER", 1, 1, 1, 1);
...
INSERT INTO customer(username, email, firstname, lastname, phone, `password`, postcode, country, city, number_house,
                     street, authorities, `account_non_expired`, `account_non_locked`, `credentials_non_expired`,
                     `enabled`)
VALUES ("locked", "locked@email.com", "locked", "locker", "6666",
        "$2a$10$qECA6EH5ND2xA.PJ5qeMnOUo.g55rBIIWQagvlHxXv4hNbBoDjTiG", 6700, "Belgique", "Arlon", 10, "rue d''arlon",
        "ROLE_USER", 0, 0, 0, 0);
...
INSERT INTO tcategory(`name`, fk_category, fk_language)
VALUES ("Guitare", "guitar", "fr");
INSERT INTO tcategory(`name`, fk_category, fk_language)
VALUES ("Batterie", "drum", "fr");
INSERT INTO tcategory(`name`, fk_category, fk_language)
VALUES ("Piano", "piano", "fr");
INSERT INTO tcategory(`name`, fk_category, fk_language)
VALUES ("Autres", "others", "fr");

INSERT INTO tcategory(`name`, fk_category, fk_language)
VALUES ("Guitar", "guitar", "en");
INSERT INTO tcategory(`name`, fk_category, fk_language)
VALUES ("Drum", "drum", "en");
INSERT INTO tcategory(`name`, fk_category, fk_language)
VALUES ("Piano", "piano", "en");
INSERT INTO tcategory(`name`, fk_category, fk_language)
VALUES ("Others", "others", "en");
